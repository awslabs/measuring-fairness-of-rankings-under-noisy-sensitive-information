...
setup(
    name="InclusiveSearchFairnessMeasurement",
    version="1.0",
    ...
    #    src/inclusive_search_fairness_measurement/cli.py
    #    For convenience I usually recommend calling it main()
    #
    # 2. Uncomment this section of the setup.py arguments; this will create
    #    bin/InclusiveSearchFairnessMeasurement (which you can obviously change!) as a script
    #    that will call your main() function, above.
    #
    # entry_points="""\
    # [console_scripts]
    # InclusiveSearchFairnessMeasurement = inclusive_search_fairness_measurement.cli:main
    # """,
    #
